...
<div class="container">
	<div class="row entry-add">
		<div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
			...
			<div class="form-group">
				{{ Form::label('paid_to', 'To Category') }}
				{{ Form::select('paid_to',$paid_with,0,array('class'=>'form-control')) }}
			</div>
			...
			<div class="form-group">
				{{ Form::label('cat_1', 'From Category') }}
				<div class="row">
					<div class="col-xs-6">
						{{ Form::select('cat_1',$cats_dd,0,array('class'=>'form-control')) }}
					</div>
			...
			<div class="btns-to-toggle">
				{{ Form::submit('Move Money',['class'=>'btn btn-primary']) }}
